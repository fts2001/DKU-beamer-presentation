...
{colframe=DKUDarkGreen, colback=boxgray, fonttitle=\bfseries}{df}
\newtcbtheorem[use counter from=defi]{lem}{Lemma}%
{colframe=DKULightGreen, colback=boxgray, fonttitle=\bfseries}{le}
\newtcbtheorem[use counter from=defi]{thm}{Theorem}%
{colframe=DKUDarkGreen, colback=boxgray, fonttitle=\bfseries}{th}


\usetheme{DKU} 
\input{./style_files_DKU/my_beamer_defs.sty}
\logo{\includegraphics[height=0.3in]{./style_files_DKU/DKU Logo_GreenTop.png}\hspace{0.05in}}
